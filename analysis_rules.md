...
The setup has stronger short-term trade quality than long-term trade quality.
Confidence is Medium based on supplied scenarios and market-data quality.
trade_judgment: good
...
| Term | Judgment | Score | Why |
|---|---|---:|---|
| Intraday | NEUTRAL | 58/100 | no same-session edge confirmed |
| Short-term | GOOD | 82/100 | income profile fits the near-expiry term |
| Medium-term | MOSTLY GOOD | 70/100 | risk/reward remains constructive |
| Long-term | NEUTRAL | 55/100 | core exposure impact is mixed |
```
